...
class Decedent extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('decedent_mdl');
		$this->data['title'] = '智慧寺院 - 往生者管理';
		...
		$this->data['sidebar'] = 'decedent';
	}

	public function index()
	{	
		$this->data['decedent'] = $this->decedent_mdl->get();
		$this->load->view('master/decedent', $this->data);
	}
}
