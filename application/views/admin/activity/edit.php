...
<div class="main row">	
	...
	<div class="alert alert-info" role="alert">
		...
		<?php if(isset($activity)) 
				echo form_open('admin/activity/edit/'.$activity->id, array('class' => 'form-inline'));
			else
				echo form_open('admin/activity/add', array('class' => 'form-inline'));?>
		<div class="form-line">
		...
		<!-- <div class="form-line">
	    	...
	    	<a href="<?php echo base_url()."admin/activity/edit_cat/$temple->id";?>" class="btn btn-default" role="button">编辑类别</a>
	    </div> -->
	    <div class="form-line">
			<?php echo form_dropdown('templeid', $templeids, !isset($activity)?null:$activity->hostid, 'class="form-control" id="templeid"');?>
	    </div>
		<div class="form-line">
