...
<div class="main row">	
	...
	<div class="alert alert-info" role="alert">
		...
		<?php if(isset($volunteer)) 
				echo form_open('admin/volunteer/edit/'.$volunteer->id, array('class' => 'form-inline'));
			else
				echo form_open('admin/volunteer/add', array('class' => 'form-inline'));?>
		<div class="form-line">
		...
		<!-- <div class="form-line">
	    	...
	    	<a href="<?php echo base_url()."admin/volunteer/edit_cat/$temple->id";?>" class="btn btn-default" role="button">编辑类别</a>
	    </div> -->
	    <div class="form-line">
			<?php echo form_dropdown('templeid', $templeids, !isset($volunteer)?null:$volunteer->hostid, 'class="form-control" id="templeid"');?>
	    </div>
		<div class="form-line">
		...
		<button type="submit" class="btn btn-info btn-sm" onclick="javascript:get_ueditor_content()">
