	...
	<div class="main container">
		<div class="info">
			<div class="text-right">
				...
				<small><a href="<?php echo base_url()."visit";?>"><span class="glyphicon glyphicon-refresh"></span>切换寺院</a></small>
			</div>
			<div class="wifi-info">
				重置密码
				...
				<div class="wifi-info-input" id="reg-login">
					<button class="btn btn-sm btn-success btn-block" onclick="javascript:resetpwd_verify_mobile('<?php echo base_url();?>')">重置密码为手机号</button>
				</div>
			</div>
		</div>
