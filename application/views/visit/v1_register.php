...
?>
			<div class="v1-index-choose">
				...
				<div class="v1-w100 v1-index-choose-btn">
					<a href="<?php echo base_url();?>login">已有帐号登录 <span class="glyphicon glyphicon-info-sign"></span></a>
					<button class="v1-btn-brown" onclick="javascript:verify_mobile('<?php echo base_url();?>')">注 册</button>
				</div>
			</div>
