...
<div class="row" style="border-top:2px solid #938561;">
	<div class="container">
		<?php $num=1;foreach ($volunteer_stick as $stick) {?>
			<a href="<?php echo base_url()."user/volunteer/id/".$stick->id;?>">
			<div class="v1-fl v1-w25 v1-focus-news-item v1-list-stick v1-volunteer-stick-bg<?php echo $num?>">
...
<div class="container">
	<div class="v1-list-group">
		...
		<a href="<?php echo base_url()."user/volunteer/id/$volunteer->id";?>" 
			...
			<div class="v1-list-news-date"><?php echo date('Y-m-d', strtotime($volunteer->inputtime));?></div>
			</div>
		</a>
		<?php }?>
	</div>
...
$(function(){  
  $(window).scroll(function() {  
      ...
      if ($(this).scrollTop() + $(window).height()>= $(document).height() && !loading) {
		...
		loading = true;
		setTimeout(function () { 
			<?php echo "more('".base_url()."','volunteer');";?>
		}, 500);
      }  
  });  
});  
